...
export const translations: Record<Locale, TranslationMap> = {
  en: {
    ...
    'hero.trust.1': 'One-time payment',
    'hero.trust.2': 'No monthly fee',
    'hero.trust.3': '0% platform commission',

    // ── ROI Calculator ──
    'roi.title': 'ROI Calculator',
    'roi.desc': 'See how much money you are leaving on the table with 3rd-party delivery apps.',
    'roi.section.title': 'Calculate how much the platforms take from you every year',
    'roi.section.subtitle': 'With your own ordering system, you no longer need to hand that money over.',
    ...
    'roi.action_hint': 'If your monthly delivery revenue is around $10k, the build cost is often covered very quickly.',
    ...
    // ── Visual Proof ──
    'visual.badge': 'Restaurant-ready visuals',
    ...
    'contact.direct.title': 'Talk to us directly',
    'contact.direct.subtitle': 'For restaurant owners, WeChat is the fastest channel. The form is there if you prefer to leave the details in one go.',
    'contact.form.title': 'Send a message',
    'contact.form.subtitle': 'If you already know what you need, leave the details here and we will follow up with a clear next step.',
    ...
    'contact.channel.whatsapp.desc': 'Available here if you prefer chat outside WeChat.',
    'contact.channel.wechat': 'WeChat',
    'contact.channel.wechat.desc': 'Add us on WeChat for the fastest reply.',
    'contact.channel.wechat.id_label': 'WeChat ID',
    'contact.channel.priority': 'We recommend WeChat first',
    'contact.channel.priority.desc': 'Most restaurant owners reply faster there, especially when menu, screenshots, or quick voice notes are involved.',
  ...
  zh: {
    ...
    'roi.section.title': '算一算，你一年被平台抽走多少钱',
    'roi.section.subtitle': '有了自己的点单系统，这笔钱就不用再交出去。',
    ...
    'contact.direct.title': '直接联系更快',
    'contact.direct.subtitle': '对中国用户来说，微信优先最自然；如果您想一次性把需求写清楚，再填写表单也可以。',
    'contact.form.title': '发送消息',
    'contact.form.subtitle': '如果您已经明确想做什么，可以直接把需求写下来，我们会尽快给您一个清晰的下一步建议。',
    ...
    'contact.channel.whatsapp': 'WhatsApp',
    'contact.channel.whatsapp.desc': '如果您更习惯用 WhatsApp，这里也可以直接开始聊天。',
    'contact.channel.wechat': '微信咨询',
    'contact.channel.wechat.desc': '微信沟通最快，扫码即可直接添加。',
    'contact.channel.wechat.id_label': '微信号',
    'contact.channel.priority': '建议优先加微信',
    'contact.channel.priority.desc': '大多数餐厅老板在微信上回复更快，发菜单、截图、语音也更方便。',
