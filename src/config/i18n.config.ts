...
export const translations: Record<Locale, TranslationMap> = {
  en: {
    ...
    // ── Hero ──
    'hero.badge': 'Taking New Clients',
    'hero.headline': 'Stop Giving 30% to Delivery Apps.',
    'hero.headline2': 'Build Your Digital Empire.',
    'hero.subheadline': 'We build independent ordering systems and high-converting websites. Drive massive traffic to your restaurant via Google & Facebook.',
    ...
    'services.2.title': 'Independent Ordering (0% Commission)',
    'services.2.desc': 'Your own branded ordering system with no platform commissions. Keep 100% of your revenue, build your customer database, and own the relationship.',
  ...
  zh: {
    ...
    'hero.subheadline': '为您搭建独立点餐系统与高转化网站。通过谷歌和Facebook精准引流，助您餐厅业绩翻倍。',
    'hero.cta': '获取免费诊断',
    'hero.cta2': '查看我们的案例',
    ...
    'services.2.title': '独立点餐系统 (0%抽成)',
    'services.2.desc': '拥有自己品牌的点餐系统,零平台佣金。100%保留您的利润,积累自有客户数据库,掌握客户关系。',
