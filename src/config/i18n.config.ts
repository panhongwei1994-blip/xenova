...
export const translations: Record<Locale, TranslationMap> = {
  en: {
    ...
    'contact.form.intent': 'What do you need?',
    'contact.form.intent.placeholder': 'Select your main interest',
    'contact.form.intent.option.showcase': 'I want a showcase site — $498',
    'contact.form.intent.option.delivery': 'I want a delivery site — $998',
    'contact.form.intent.option.other': 'I have another question',
  ...
  zh: {
    ...
    'contact.form.intent': '您的需求是？',
    'contact.form.intent.placeholder': '请选择您的初步意向',
    'contact.form.intent.option.showcase': '我想做展示站 $498',
    'contact.form.intent.option.delivery': '我想做外卖站 $998',
    'contact.form.intent.option.other': '我有其他问题',
